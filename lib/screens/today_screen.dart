...
class _TodayScreenState extends State<TodayScreen> with WidgetsBindingObserver {
  ...
  Widget buildCircularIconButton({
    ...
    double size = 32, // Устанавливаем размер по умолчанию 32
  }) {
    return Container(
      width: size,
      height: size,
      ...
      child: InkWell(
        ...
        child: Padding(
          padding: const EdgeInsets.all(
              0), // Убираем внутренние отступы, чтобы иконка занимала весь контейнер
          child: SvgPicture.asset(
            iconAsset,
            width:
                size, // Устанавливаем ширину иконки равной размеру контейнера
            height:
                size, // Устанавливаем высоту иконки равной размеру контейнера
          ),
        ),
      ),
    );
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: Theme.of(context)
              .textTheme
              .displayMedium, // Используем стиль displayMedium из AppTheme
        ),
        actions: [
          ...
          buildCircularIconButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      NotificationsScreen(userEmail: userProvider.email ?? ''),
                ),
              );
            },
            size: 32,
