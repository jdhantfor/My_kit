      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildActionOrHabitOption(context, 'Зарядка', 'exercise'),
            const SizedBox(height: 16),
            _buildActionOrHabitOption(context, 'Питьё воды', 'water_drinking'),
            const SizedBox(height: 16),
            _buildActionOrHabitOption(context, 'Тренировка', 'workout'),
            const SizedBox(height: 16),
            _buildActionOrHabitOption(context, 'Прогулка', 'walk'),
            const SizedBox(height: 16),
            _buildActionOrHabitOption(context, 'Бег', 'running'),
