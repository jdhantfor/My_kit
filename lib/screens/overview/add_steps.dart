...
class _AddStepsState extends State<AddSteps> {
  ...
  // Максимальное значение для шагов
          ...
          TextField(
            ...
            inputFormatters: isNumeric
                ? [
                    ...
                    // Ограничение на ввод значений до 20000
                    TextInputFormatter.withFunction((oldValue, newValue) {
                      final value = int.tryParse(newValue.text);
                      if (value == null || value > _maxSteps) {
                        return oldValue; // Отклоняем ввод, если значение больше 20000
                      }
                      return newValue;
                    }),
                  ]
  ...
  void _saveSteps() async {
    ...
    if (steps == null || steps > _maxSteps) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Количество шагов не должно превышать 20000')),
      );
      return;
    }
