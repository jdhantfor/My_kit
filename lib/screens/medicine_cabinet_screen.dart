...
class _MedicineCabinetScreenState extends State<MedicineCabinetScreen> {
  ...
  Future<void> _loadMedicines() async {
    ...
    final loadedMedicines =
        await databaseService.getMedicines(userId, currentUserId);
    setState(() {
  ...
  Future<void> _exportMedicineCabinet() async {
                        ...
                        children: [
                          ...
                          pw.Column(
                            ...
                            children: [
                              ...
                              if (releaseForm != null && releaseForm.isNotEmpty)
                                pw.SizedBox(
                                  width: 94,
                                  child: pw.Text(
                                    releaseForm,
    ...
    final file = File("${output!.path}/medicine_cabinet.pdf");
    await file.writeAsBytes(await pdf.save());
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('PDF сохранен в: /medicine_cabinet.pdf')),
    );
  }
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color.fromRGBO(
                            129, 132, 153, 0.08), // Новый цвет
                        borderRadius: BorderRadius.circular(6), // Закругление 6
                      ),
                      child: IconButton(
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                          fontFamily: 'Commissioner',
                          fontSize: 12, // Шрифт 12
                          fontWeight: FontWeight.w400, // Вес 400
                          color: Color(0xFF0B102B),
                        ),
                      ),
                    ),
